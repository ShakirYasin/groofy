...
const VideoCard:NextPage<IProps> = ({post}) => {
    ...
    const date = moment(new Date(post._createdAt || "")).format('DD MMM, YYYY')
    ...
    <div className='flex flex-col border-b-2 border-gray-200 pb-6'>
                ...
                <div>
                    <Link href={`/profile/${post.postedBy._id}`}>
                        <div className='flex items-center gap-2'>
                            ...
                            <p className='capitalize font-medium text-xs text-gray-500 sm:hidden md:block'>
                                {post.postedBy.userName}
                            </p>
                        </div>
                    </Link>
        ...
        <div className='lg:ml-20 flex gap-4'>
            ...
            className='rounded-3xl relative'>
                ...
                {isHover && (
                    <div className='absolute lg:bottom-0 bottom-6 cursor-pointer left-8 md:left-14 lg:left-0 flex gap-10 lg:justify-between w-[100px] md:w-[100px] p-3'>
                        {playing ? (
                            ...
                            <button onClick={onVideoPress}>
                                <BsFillPlayFill className='text-black text-2xl lg:text-3xl' />
                            </button>
                        )}
                        {isVideoMuted ? (
